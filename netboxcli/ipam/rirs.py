class Rirs:
    ...
    def get(
        ...
        """
        Get a resource from the rirs on ID, name, tags, or search query.
        ...
        Examples:
            ...
            >>> result = nb.ipam.rirs.get(id=1)

            Get a resource by name:
            >>> result = nb.ipam.rirs.get(name="resource_name")

            Get resources by tags:
            >>> result = nb.ipam.rirs.get(tags=["tag1", "tag2"])

            Get resources by search query:
            >>> result = nb.ipam.rirs.get(search="query")

            Get resources by filter query:
               >>> result = nb.ipam.rirs.get(filter="assigned_to_interface=True")

            Get all resources:
            >>> result = nb.ipam.rirs.get()

        Returns:
            Returns a list with a status code and the request data in JSON format: {status: 200, data: {result: [list of rirs]}}
        """
        return self._core.get(id, name, tags, search, limit)

    def create(self, data) -> dict:
        """
        Create a new resource in rirs using the provided data.
        ...
        Examples:
            ...
            >>> result = nb.ipam.rirs.create(data)

        Returns:
            dict: {'status': 200, 'data': {'result': rirs]}}
        """
        return self._core.create(data)

    def update(self, data: list) -> dict:
        """
        Update an existing resource in rirs with the provided data.
        ...
        Examples:
            ...
            >>> result = nb.ipam.rirs.update(data)
        """
    ...
    def delete(self, id: int) -> dict:
        ...
        Args:
            id (int): ID of the resource in rirs to delete.
        ...
        Examples:
            ...
            >>> result = nb.ipam.rirs.delete(id=1)
