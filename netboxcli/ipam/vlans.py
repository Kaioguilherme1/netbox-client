class Vlans:
    """
    Responsable for managing VLANs
    ...
    def get(
        ...
        """
        Get a resource from the vlans on ID, name, tags, or search query.
        ...
        Examples:
            ...
            >>> result = nb.ipam.vlans.get(id=1)

            Get a resource by name:
            >>> result = nb.ipam.vlans.get(name="resource_name")

            Get resources by tags:
            >>> result = nb.ipam.vlans.get(tags=["tag1", "tag2"])

            Get resources by search query:
            >>> result = nb.ipam.vlans.get(search="query")

            Get resources by filter query:
               >>> result = nb.ipam.vlans.get(filter="assigned_to_interface=True")

            Get all resources:
            >>> result = nb.ipam.vlans.get()

        Returns:
            Returns a list with a status code and the request data in JSON format: {status: 200, data: {result: [list of vlans]}}
        """
        return self._core.get(id, name, tags, search, limit)

    def create(self, data) -> dict:
        """
        Create a new resource in vlans using the provided data.
        ...
        Examples:
            ...
            >>> result = nb.ipam.vlans.create(data)

        Returns:
            dict: {'status': 200, 'data': {'result': vlans]}}
        """
        return self._core.create(data)

    def update(self, data: list) -> dict:
        """
        Update an existing resource in vlans with the provided data.
        ...
        Examples:
            ...
            >>> result = nb.ipam.vlans.update(data)
        """
    ...
    def delete(self, id: int) -> dict:
        ...
        Args:
            id (int): ID of the resource in vlans to delete.
        ...
        Examples:
            ...
            >>> result = nb.ipam.vlans.delete(id=1)
