class ImageAttachments:
    """
    Responsable for managing image attachments
    ...
    def get(
        ...
        """
        Get a resource from the image_attachments on ID, name, tags, or search query.
        ...
        Examples:
            ...
            >>> result = nb.customization.image_attachments.get(id=1)

            Get a resource by name:
            >>> result = nb.customization.image_attachments.get(name="resource_name")

            Get resources by tags:
            >>> result = nb.customization.image_attachments.get(tags=["tag1", "tag2"])
        ...
        Returns:
            Returns a list with a status code and the request data in JSON format: {status: 200, data: {result: [list of image_attachments]}}
        """
        return self._core.get(id, name, tags, search, limit)

    def create(self, data) -> dict:
        """
        Create a new resource in image_attachments using the provided data.
        ...
        Examples:
            ...
            >>> result = nb.customization.image_attachments.create(data)

        Returns:
            dict: {'status': 200, 'data': {'result': image_attachments]}}
        """
        return self._core.create(data)

    def update(self, data: list) -> dict:
        """
        Update an existing resource in image_attachments with the provided data.
        ...
        Examples:
            ...
            >>> result = nb.customization.image_attachments.update(data)
        """
    ...
    def delete(self, id: int) -> dict:
        ...
        Args:
            id (int): ID of the resource in image_attachments to delete.
        ...
        Examples:
            ...
            >>> result = nb.customization.image_attachments.delete(id=1)
