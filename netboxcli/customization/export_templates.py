class ExportTemplates:
    """
    Responsable for managing export templates
    ...
    def get(
        ...
        """
        Get a resource from the export_templates on ID, name, tags, or search query.
        ...
        Examples:
            ...
            >>> result = nb.customization.export_templates.get(id=1)

            Get a resource by name:
            >>> result = nb.customization.export_templates.get(name="resource_name")

            Get resources by tags:
            >>> result = nb.customization.export_templates.get(tags=["tag1", "tag2"])
        ...
        Returns:
            Returns a list with a status code and the request data in JSON format: {status: 200, data: {result: [list of export_templates]}}
        """
        return self._core.get(id, name, tags, search, limit)

    def create(self, data) -> dict:
        """
        Create a new resource in export_templates using the provided data.
        ...
        Examples:
            ...
            >>> result = nb.customization.export_templates.create(data)

        Returns:
            dict: {'status': 200, 'data': {'result': export_templates]}}
        """
        return self._core.create(data)

    def update(self, data: list) -> dict:
        """
        Update an existing resource in export_templates with the provided data.
        ...
        Examples:
            ...
            >>> result = nb.customization.export_templates.update(data)
        """
    ...
    def delete(self, id: int) -> dict:
        ...
        Args:
            id (int): ID of the resource in export_templates to delete.
        ...
        Examples:
            ...
            >>> result = nb.customization.export_templates.delete(id=1)
