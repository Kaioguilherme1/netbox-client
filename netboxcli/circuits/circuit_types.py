class CircuitTypes:
    """
    Responsible for managing circuit types
    ...
    def get(
        ...
        """
        Get a resource from the circuit_types on ID, name, tags, or search query.
        ...
        Examples:
            ...
            >>> result = nb.circuits.circuit_types.get(id=1)

            Get a resource by name:
            >>> result = nb.circuits.circuit_types.get(name="resource_name")

            Get resources by tags:
            >>> result = nb.circuits.circuit_types.get(tags=["tag1", "tag2"])
        ...
        Returns:
            Returns a list with a status code and the request data in JSON format: {status: 200, data: {result: [list of circuit_types]}}
        """
        return self._core.get(id, name, tags, search, limit)

    def create(self, data) -> dict:
        """
        Create a new resource in circuit_types using the provided data.
        ...
        Examples:
            ...
            >>> result = nb.circuits.circuit_types.create(data)

        Returns:
            dict: {'status': 200, 'data': {'result': circuit_types]}}
        """
        return self._core.create(data)

    def update(self, data: list) -> dict:
        """
        Update an existing resource in circuit_types with the provided data.
        ...
        Examples:
            ...
            >>> result = nb.circuits.circuit_types.update(data)
        """
    ...
    def delete(self, id: int) -> dict:
        ...
        Args:
            id (int): ID of the resource in circuit_types to delete.
        ...
        Examples:
            ...
            >>> result = nb.circuits.circuit_types.delete(id=1)
