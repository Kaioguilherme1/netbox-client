class ProviderAccounts:
    """
    Responsible for managing provider accounts
    ...
    def get(
        ...
        """
        Get a resource from the provider_accounts on ID, name, tags, or search query.
        ...
        Examples:
            ...
            >>> result = nb.circuits.provider_accounts.get(id=1)

            Get a resource by name:
            >>> result = nb.circuits.provider_accounts.get(name="resource_name")

            Get resources by tags:
            >>> result = nb.circuits.provider_accounts.get(tags=["tag1", "tag2"])
        ...
        Returns:
            Returns a list with a status code and the request data in JSON format: {status: 200, data: {result: [list of provider_accounts]}}
        """
        return self._core.get(id, name, tags, search, limit)

    def create(self, data) -> dict:
        """
        Create a new resource in provider_accounts using the provided data.
        ...
        Examples:
            ...
            >>> result = nb.circuits.provider_accounts.create(data)

        Returns:
            dict: {'status': 200, 'data': {'result': provider_accounts]}}
        """
        return self._core.create(data)

    def update(self, data: list) -> dict:
        """
        Update an existing resource in provider_accounts with the provided data.
        ...
        Examples:
            ...
            >>> result = nb.circuits.provider_accounts.update(data)
        """
    ...
    def delete(self, id: int) -> dict:
        ...
        Args:
            id (int): ID of the resource in provider_accounts to delete.
        ...
        Examples:
            ...
            >>> result = nb.circuits.provider_accounts.delete(id=1)
