class CircuitsClass:
    """
    Respomsible for managing circuits
    ...
    def get(
        ...
        """
        Get a resource from the circuits on ID, name, tags, or search query.
        ...
        Examples:
            ...
            >>> result = nb.circuits.circuits.get(id=1)

            Get a resource by name:
            >>> result = nb.circuits.circuits.get(name="resource_name")

            Get resources by tags:
            >>> result = nb.circuits.circuits.get(tags=["tag1", "tag2"])
        ...
        Returns:
            Returns a list with a status code and the request data in JSON format: {status: 200, data: {result: [list of circuits]}}
        """
        return self._core.get(id, name, tags, search, limit)

    def create(self, data) -> dict:
        """
        Create a new resource in circuits using the provided data.
        ...
        Examples:
            ...
            >>> result = nb.circuits.circuits.create(data)

        Returns:
            dict: {'status': 200, 'data': {'result': circuits]}}
        """
        return self._core.create(data)

    def update(self, data: list) -> dict:
        """
        Update an existing resource in circuits with the provided data.
        ...
        Examples:
            ...
            >>> result = nb.circuits.circuits.update(data)
        """
    ...
    def delete(self, id: int) -> dict:
        ...
        Args:
            id (int): ID of the resource in circuits to delete.
        ...
        Examples:
            ...
            >>> result = nb.circuits.circuits.delete(id=1)
